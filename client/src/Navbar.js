...
class Navbar extends Component {
    ...
    isLoggedIn = () => {
        axios.get("isLogged").then(res => {console.log(res.data);return res.data}).then(e => this.setState({ success: e.success, userID: e.user ? e.user._id : null })).catch(e=>console.log(e))
    }
