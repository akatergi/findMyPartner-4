...
class UpdateUserM extends Component {
    ...
    componentDidMount = () => {
        axios.get(`http://localhost:5000/isLogged`, {
            ...
            withCredentials: true
        }).then(res => res.data).then(e => { console.log(e); e.success ? this.setState({ success: true, languages: e.user.languages.toString(), skills: e.user.skills.toString(), username: e.user.username, _id:e.user._id, password: e.user.password, description: e.user.description, email: e.user.email, image: e.user.image }) : this.setState({ success: false }) })
    }
                ...
                <div className="row">
                    <div className="col-6 mb-3">
                        <div className="form-group" >
                            ...
                            <input required className="form-control" type="text" name="username" value={this.state.username} onChange={this.handleChange} />
                        </div>
                    </div>
                    <div className="col-6 mb-3">
                        <div className="form-group" >
